...
function inferIndentation(line, contextLines, previousIndent = "") {
...
export function applyContextMatching(hunk, content, matchPosition) {
	if (matchPosition === -1) {
...
// DMP edit strategy
export function applyDMP(hunk, content, matchPosition) {
	if (matchPosition === -1) {
...
export async function applyGitFallback(hunk, content) {
	let tmpDir
	try {
...
export async function applyEdit(hunk, content, matchPosition, confidence, confidenceThreshold = 0.97) {
...
//# sourceMappingURL=edit-strategies.js.map
